...
| [skills/](skills/README.md) | Capability modules; Knowledge and resources; Outputs and schemas; Guardrails and governance; Evaluation and observability; Runtime and deployment | A synthetic Agent Skills-compatible package mapped from the generic capability-module concept; see the [mapping guide](../docs/agent-skills-standard-mapping.md) and [connected record-triage example](record-triage-agent/README.md) |
| [ui-harness/](ui-harness/README.md) | Prompts and interfaces; State; Planning and orchestration; Guardrails and governance; Outputs and schemas; Evaluation and observability; Runtime and deployment | A synthetic, non-production interaction harness artifact set for a deterministic brief-building workflow |
...
- [UI and interaction harness guide](../docs/ui-harness-artifacts.md)
